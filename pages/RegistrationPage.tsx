         ...
         <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div className="max-w-md w-full bg-white dark:bg-slate-800 shadow-xl rounded-lg p-8 space-y-6">
                ...
                <div className="text-center">
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-200">Create Your Account</h1>
                    <p className="text-slate-500 dark:text-slate-400">Join the Library Management System</p>
                </div>
