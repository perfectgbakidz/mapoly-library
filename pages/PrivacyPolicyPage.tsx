...
const PrivacyPolicyPage: React.FC = () => {
    return (
        <div className="bg-white p-6 md:p-8 rounded-lg shadow-md max-w-4xl mx-auto">
            <h1 className="text-2xl font-bold text-slate-800 mb-4 border-b pb-3">Privacy Policy</h1>
            <div className="space-y-4 text-slate-600">
                ...
                <h2 className="text-xl font-semibold text-slate-700 pt-4">Interpretation and Definitions</h2>
                <h3 className="text-lg font-semibold text-slate-700">Interpretation</h3>
                <p>
                    The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                </p>

                <h2 className="text-xl font-semibold text-slate-700 pt-4">Collecting and Using Your Personal Data</h2>
                <h3 className="text-lg font-semibold text-slate-700">Types of Data Collected</h3>
                <p>
